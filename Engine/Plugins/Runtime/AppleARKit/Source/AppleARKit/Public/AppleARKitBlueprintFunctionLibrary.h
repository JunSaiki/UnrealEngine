...
UCLASS()
class APPLEARKIT_API UAppleARKitBlueprintFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	
	/** 
	 * Returns the module singelton UAppleARKitSession create and destroyed during StartupModule & 
